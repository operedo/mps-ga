...
subroutine loadHistogramCells_baseline(matrix,rows,cols,tem_rows,tem_cols,tem_cells,tem_cells_rows,tem_cells_cols,clock_rate)
...
end subroutine loadHistogramCells_baseline
