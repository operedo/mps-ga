...
subroutine fitnessFunctionChainOperationsCells(realization_matrix,rows,cols,tem_rows, tem_cols, value,tem_cells,tem_cells_rows,tem_cells_cols,unrolls,nblocks)
  ...
  integer(4)                :: freq_realization(nchains),freq_realization_byid(nchains,12)
  ...
  !!$OMP PARALLEL PRIVATE(localChain,chainArray,pos,icol,irow,colplus1,colplus5,colplus6,colplus7,colplus11,rowplus1,rowplus5,rowplus6,rowplus7,rowplus11)&
